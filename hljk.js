 ...
 * 原作者: Peng-YM | Alter: chxm1023 | 强化: 自动换算 + NGN + 容错
 ****************************************/
...
/* === Access Key ===
 * 优先读持久化 EXR_ACCESS_KEY；没有就用下方默认值
...
/* ========== 请求 EUR 基准的数据（exchangeratesapi.io 免费档） ========== */
async function fetchEURBase(){
  ...
  // 异常结构：{ success:false, error:{ code, type, info } }
